...
public class Purify {
	public static void main(String[] args) {
		...
		String fileName = "/Users/weizhang/workspace/EventsRecom/tomcat_log.txt";
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				// Sample input: 
				// 73.223.210.212 - - [19/Aug/2017:22:00:24 +0000] "GET /Rudy/history?user_id=1111 HTTP/1.1" 200 11410
