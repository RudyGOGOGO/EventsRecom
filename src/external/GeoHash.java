package external;
/*
 * since TicketMaster ask for GeoPoint instead of 
 * latitude and longitude directly in request, 
 * we need a helper class to do GeoHash encoding for us. 
 * The code here is copied from an simple implementation 
 * from http://developer-should-know.com/post/87283491372/geohash-encoding-and-decoding-algorithm.
 */
//convert latitude and longitude into Geo Hash
